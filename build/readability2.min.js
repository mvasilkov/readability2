...
q.Title.prototype.getTitle=function(){var a=this.document,b=a.headings,c=a.title;if(0==b.length)return c;if(1==b.length)return b[0];if(c){var f=new l.CString(c);a=b.filter(function(a){return a.length<=c.length&&f.includes(a)}).sort(function(a,b){return b.length-a.length});if(a.length)return a[0]}return b[0]};q.Title.normalizeSpace=function(a){return n.normalizeSpace(a).replace(/\n{1,2}/gu," ")};q.Title.normalizeTitle=function(a){a=a.split("::",1)[0];return q.Title.normalizeSpace("\n\n"+a+"\n\n")};var r={Reader:function(){this._cur=this.root=new h.Node("---");this.title=new q.Title}};r.Reader.prototype.onopentag=function(a){a=a.toLowerCase();this._cur=this._cur.appendChild(new h.Node(a));this._cur.variety=this._cur.parentNode.variety;e.bad.has(a)&&(this._cur.variety|=2);e.hyper.has(a)&&(this._cur.variety|=1)};
r.Reader.prototype.onclosetag=function(a){a=a.toLowerCase();if(this._cur.tagName!=a||null==this._cur.parentNode)throw Error("onclosetag: Not balanced");var b=this._cur;this._cur=this._cur.parentNode;if(b.trash||e.junk.has(a))this._cur.childNodes.pop();else if(e.heading.has(a))this.title.append(b);else switch(a){case "br":this._cur.childNodes.splice(-1,1,p.Newline.instance)}};
...
t.Readability.prototype.clean=function(){if(null==this._result)return"";null==this._cleaner&&(this._cleaner=new k.Cleaner(this._result.node));return n.normalizeSpace(this._cleaner.root.toString())};t.Readability.prototype.getTitle=function(){return this.reader.title.getTitle()};window.Readability=t.Readability;})()